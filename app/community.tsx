...
const styles = StyleSheet.create({
  ...
  postUsernameRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  commentPreviews: { paddingHorizontal: spacing.md, paddingBottom: spacing.sm, gap: 2 },
  commentPreviewText: { fontSize: 12, color: colors.textSecondary, lineHeight: 17 },
  commentDot: { color: colors.primary, fontWeight: '700' },
  ...
  commentCount: { fontSize: 14, color: colors.textSecondary, fontWeight: '600' },
  shareBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, marginLeft: 'auto' as any },
  ...
  leaderUsernameRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  leaderUsername: { fontSize: 15, fontWeight: '700', color: colors.textPrimary },
  leaderBigFish: { fontSize: 12, color: colors.textSecondary },
  leaderMeta: { flexDirection: 'row', alignItems: 'center', gap: 3, marginTop: 2 },
  leaderHomeWater: { fontSize: 11, color: colors.textSecondary, flex: 1 },
  leaderLevelBadge: { backgroundColor: 'rgba(0,212,170,0.12)', borderRadius: radius.full, paddingHorizontal: 6, paddingVertical: 1 },
  leaderLevelText: { fontSize: 10, color: colors.primary, fontWeight: '700' },
